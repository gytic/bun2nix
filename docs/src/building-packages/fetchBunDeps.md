...
| `autoPatchElf`      | If any elf files that exist in your bun dependencies should be patched. See [`autoPatchelfHook`](https://ryantm.github.io/nixpkgs/hooks/autopatchelf/#setup-hook-autopatchelfhook).                                                                                                                     |
