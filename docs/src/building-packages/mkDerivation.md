...
This function is intended for use building [binaries with bun](https://bun.com/docs/bundler/executables). If you need to build something like a compiled react
